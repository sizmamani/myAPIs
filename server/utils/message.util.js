...
const ERRORS = {
    ...
    POST_DESCRIPTION_IS_REQUIRED: generateError(1504, 'POST DESCRIPTION IS REQUIRED'),
    POST_OWNER_UPDATE_ONLY: generateError(1505, 'ONLY POST OWNER CAN UPDATE THE POST'),
