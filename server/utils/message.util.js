...
const ERRORS = {
    ...
    //1501-1599
    INVALID_POST_ID: generateError(1501, 'INVALID POST ID'),
    POST_DOES_NOT_EXIST: generateError(1502, 'POST DOES NOT EXIST'),
    POST_CANNOT_BE_VIEWED: generateError(1503, 'POST CANNOT BE VIEWED'),
